...
public class Main{
    public static void main(String[]args){
        ...
        GeneticAlgorithm obj_ga=new GeneticAlgorithm(9,0.01,0.95,0);
        Population obj_pop=obj_ga.initPopulation(6);
           ...
           // System.out.println("S "+obj_pop.getFittest(0).getI());
            ...
            for(int i=0;i<obj_pop.getSize();i++){
               // System.out.print("==X "+obj_pop.getIndividual(i).getValue()+"==");
                ...
                System.out.println("Si "+i+" ["+obj_pop.getIndividual(i).toString()+"]");
            }
        ...
        System.out.println("Best solution ["+obj_pop.getIndividual(0).toString()+"]");
        /*
            commands
            javac -cp lib/jade.jar src/examples/H7/Population.java src/examples/H7/Individual.java src/examples/H7/GeneticAlgorithm.java src/examples/H7/Main.java -d classes/
            java -cp lib/jade.jar:classes/ jade.Boot -gui agente:examples.H7.Main
         */
    }
}